  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-ieee text-primary-foreground shadow-lift hover:-translate-y-0.5 hover:brightness-110",
        onDark:
          "bg-navy-foreground text-navy hover:-translate-y-0.5 hover:brightness-95 shadow-soft",
        outlineDark:
          "border border-navy-foreground/35 text-navy-foreground hover:bg-navy-foreground/10 hover:-translate-y-0.5",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-border bg-background shadow-soft hover:border-primary/50 hover:text-primary hover:-translate-y-0.5",
